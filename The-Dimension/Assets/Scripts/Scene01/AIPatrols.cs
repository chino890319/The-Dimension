...
public class AIPatrols : MonoBehaviour
{
   ...
   //依序巡邏巡邏點
    ...
    //殺手活躍
    public static bool KillerMove = true;
    //主角進入靈界
    public static bool shining = false;
    //AI
 ...
 IEnumerator Attacktime()
    ...
    void Update()
    {
        ...
        //print(destPoint);
        if(PlayerControl.Shinetimer == 2 && kill == false)
        {
            shining = true;
        ...
        if(KillerMove == true)
        {
            ...
            distance2 = this.transform.position.y - Player.transform.position.y;
            //接近下個巡邏點 OR 離主角距離>8f
            ...
            //斬殺主角
            if(distance < 2f && distance2 < 0f && kill == false && shining == false)
            {
                //斬殺音效
                sound.clip = voice[0];
                sound.loop = false;
            ...
            //發現主角
            if(distance > 2f && distance < 8f &&  distance2 < 0f && shining == false)
            {
